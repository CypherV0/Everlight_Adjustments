...
class CfgPatches {
  class ADDON {
    ...
    weapons[] = {};
    requiredVersion = 1.0;
    requiredAddons[] = {"evlt_main","evlt_medical","A3_Supplies_F_Exp","ace_main","ace_compat_rhs_afrf3","ace_compat_rhs_usf3","UK3CB_Factions_Weapons","rhssaf_c_weapons","rhsusf_c_weapons","niaweapons_226","UK3CB_Factions_Weapons","rhs_main","rhsusf_main","rhs_c_weapons","rhsusf_c_weapons"};
    author[] = {"Ferdilanz"};
    authorUrl = "";
  };
};
